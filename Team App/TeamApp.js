...
class Team{
    constructor(id, name){
        this.id=id;
        this.name=name;
        this.members= []; // array to hold all members that get added to the team
    }
    ...
    deleteMember(member){
        let index = this.memners.indexOf(member);
        this.members.splice(index,1); // the 1 here means that one member is going to be removed
    }
}
